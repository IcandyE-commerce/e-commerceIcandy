...
import { CategoriaApi } from '../../components/api/Categoria';
...
export default function Page() {
  ...
  const CategoriaCtrl = new CategoriaApi();
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (!Categoria) return;
      try {
        const response = await CategoriaCtrl.getBySlug(Categoria);
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4">Productos en la categoría: {Categoria}</h1>
      <div className="mb-4">
